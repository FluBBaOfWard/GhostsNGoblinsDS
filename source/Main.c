...
//---------------------------------------------------------------------------------
	...
	REG_BG0CNT = BG_32x32 | BG_MAP_BASE(0) | BG_COLOR_16 | BG_TILE_BASE(1) | BG_PRIORITY(1);
	REG_BG1CNT = BG_64x32 | BG_MAP_BASE(1) | BG_COLOR_16 | BG_TILE_BASE(2) | BG_PRIORITY(2);
	REG_BG2CNT = BG_64x32 | BG_MAP_BASE(3) | BG_COLOR_16 | BG_TILE_BASE(2) | BG_PRIORITY(1);
...
//	myStream.callback		= mix_sound;				// set callback function
	myStream.callback		= soundVbl2;				// set callback function
